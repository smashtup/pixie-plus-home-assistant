    ...
    async def async_step_user(self, user_input: Optional[Mapping] = None):
        ...
        if user_input is None or pixieplus_cloud is None or errors:
            return self.async_show_form(
                step_id="pixieplus_cloud_connection",
        ...
        for device in await self.hass.async_add_executor_job(pixieplus_cloud.devices()):
            ...
            devices.append({
                ...
                CONF_MODEL: PIXIE_DEVICES_SPECS[device[CONF_TYPE]][device[CONF_STYPE]][CONF_MODEL],
                CONF_MANUFACTURER: PIXIE_DEVICES_SPECS[device[CONF_TYPE]][device[CONF_STYPE]][CONF_MANUFACTURER],
